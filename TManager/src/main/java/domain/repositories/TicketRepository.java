...
public class TicketRepository implements ITicketRepository{
    ...
    public ArrayList<TicketEntity> getByCategoryName(String categoryName) {
        ...
        ArrayList<TicketEntity> result = (ArrayList<TicketEntity>) entityManager.createQuery("SELECT t from TicketEntity t where t.category  = :categoryId").getResultList();
    ...
    public List<TicketEntity> find() {
        ...
        List<TicketEntity> result =  (List<TicketEntity>) query.getResultList();
